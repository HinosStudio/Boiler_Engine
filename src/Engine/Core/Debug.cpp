...
Debug::Debug(Renderer* renderer, const Rect &rect) : _renderer{renderer}, _rect{rect}, _fps{}, _lastUpdate {SDL_GetPerformanceCounter()} {
...
void Debug::Draw(const Renderer &renderer) {
    ...
    renderer.DrawRectangle(_rect, SDL_Color{80,80,80,255});
    renderer.DrawText(_rect, text, SDL_Color{10,10,10,255});
}
